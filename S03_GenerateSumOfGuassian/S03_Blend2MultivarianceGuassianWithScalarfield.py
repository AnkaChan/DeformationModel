...
if __name__ == '__main__':
    obj2vtkFolder(r'C:\Code\MyRepo\02_Geometry\DeformationModel\S05_ReverseEngineeringOfMergeTree')
    exit()
    outFolder = r'F:\WorkingCopy2\2021_02_15_TestIsometricDeformation\Input\BlendGuassians2'
