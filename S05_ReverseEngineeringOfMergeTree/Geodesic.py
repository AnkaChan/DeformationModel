...
# obj2vtkFolder('./Data/Geodesic.py/larger_domain/', outVtkFolder='./Data/Geodesic.py/larger_domain/')

# inputScalarField = './Data/Geodesic.py/larger_domain/MultiGaussian0.obj'
#
# inputSegmentedField = './Data/Geodesic.py/larger_domain/Seg0.vtk'
# inputMergeTreeNodesField = './Data/Geodesic.py/larger_domain/Node0.vtk'
inputScalarField = './Data/Geodesic.py/larger_domain/MultiGaussian1/MultiGaussian1.obj'
inputSegmentedField = './Data/Geodesic.py/larger_domain/MultiGaussian1/Seg1.vtk'
...
# inputScalarField = './Data/Geodesic.py/original/MultiGaussian0/MultiGaussian0.obj'
# inputSegmentedField = './Data/Geodesic.py/original/MultiGaussian0/Seg0.vtk'
# inputMergeTreeNodesField = './Data/Geodesic.py/original/MultiGaussian0/Node0.vtk'
# inputScalarField = './Data/Geodesic.py/original/MultiGaussian1/MultiGaussian1.obj'
# inputSegmentedField = './Data/Geodesic.py/original/MultiGaussian1/Seg1.vtk'
# inputMergeTreeNodesField = './Data/Geodesic.py/original/MultiGaussian1/Node1.vtk'
...
contourEdges, contourLineConstraintWeight, contourLineConstraintHeight = findContourLineConstraints(fieldSeg, gridSize,
                                                                                                    contourLineHeight)
contourInfoPath = './Data/Geodesic.py/larger_domain/MultiGaussian1/ContourInfo'
